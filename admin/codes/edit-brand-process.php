...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sqlCheckNameExistence = "SELECT id FROM category WHERE name = '$title' AND id != $brand_id";
    ...
    $sqlCheckUrlExistence = "SELECT id FROM category WHERE url = '$url' AND id != $brand_id";
